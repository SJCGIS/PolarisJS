define([
  ...
  var PrintDijit = declare([_WidgetBase, _TemplatedMixin, _WidgetsInTemplateMixin], {
    ...
    pdfIcon: require.toUrl("cmv/dijit/Print/images/pdf.png"),
    imageIcon: require.toUrl("cmv/dijit/Print/images/image.png"),
    printTaskURL: null,
    printTask: null,
    postCreate: function() {
      this.inherited(arguments)
      this.printTask = new PrintTask(this.printTaskURL, {async:true})
